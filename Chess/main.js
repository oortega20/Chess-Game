...
//TODO: each method should do one thing remember this oscar
// TODO: don't work on this till you do the paper oscar. you don't have as much time as you're saying you have
        ...
        for (var i = 0; i < pieces.length; i++) {
            ...
            for (var j = 0; j < potentialTiles.length; j++) {
                if(kSquare == potentialTiles[j]) {
                    alert("dang son, you now in check");
                    this.isCheck = true;
                }
            }
        }
